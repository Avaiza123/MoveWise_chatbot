...
2. Run: `backend/run.bat` (Windows) or `backend/run.sh` (Linux/Mac)
...
| Fitness Data | `backend/app/knowledge_base/fitness_knowledge.py` |
| Health Data | `backend/app/knowledge_base/health_knowledge.py` |
| Diet Data | `backend/app/knowledge_base/diet_knowledge.py` |
| Food Data | `backend/app/knowledge_base/food_database.py` |
| Chatbot Logic | `backend/app/chatbot_engine.py` |
...
| Task | Command |
|------|---------|
| Start Server (Windows) | `backend\run.bat` |
| Start Server (Linux/Mac) | `cd backend && ./run.sh` |
| Run Tests | `cd backend && python test_chatbot.py` |
