...
DIET_RESPONSES = {
    "common_questions": {
        ...
        "creatine": "Creatine monohydrate is one of the best-studied supplements. Take 3-5g daily, any time of day, consistently. It supports strength, power, recovery, and muscle fullness. It is not a steroid and does not require cycling for most people.",
        "intermittent_fasting": "Intermittent fasting can help some people eat fewer calories and simplify meal timing. It is not magic. The main drivers of fat loss are still calorie balance, protein intake, activity, and sleep. Use it if it fits your lifestyle and does not cause bingeing.",
        "meal_prep": "Meal prep works best when you repeat simple meals: a protein, a carb, a vegetable, and a fat. Batch-cook 2-3 proteins, 2 carbs, and 2 vegetables so you can mix and match through the week.",
        "pre_workout_meal": "A good pre-workout meal is easy to digest and gives you energy: carbs + moderate protein, lower fat and fiber. Examples: banana and yogurt, oats and whey, rice and chicken.",
        "post_workout_meal": "A good post-workout meal includes protein and carbs. It helps recovery and replenishes glycogen. Examples: chicken and rice, eggs and toast, protein shake and fruit, or Greek yogurt with banana.",
        "high_protein_snacks": "High-protein snacks include Greek yogurt, cottage cheese, boiled eggs, canned tuna, protein shakes, edamame, turkey slices, and roasted chickpeas. Aim for 15-25g protein per snack if possible.",
        "water_intake": "Hydration needs vary, but a simple target is to drink regularly through the day and more around training. Pale yellow urine usually means you are hydrated enough. Heavy sweating, heat, and long workouts mean you need more fluids and maybe electrolytes.",
        "sleep_and_body_comp": "Poor sleep can increase hunger, reduce recovery, and make fat loss harder. If you are trying to lose fat or build muscle, sleep is part of the plan, not optional.",
        "late_night_snacking": "Late-night snacking only becomes a problem if it pushes you into a calorie surplus. If it is controlled and fits your calories, it is fine. High-protein, higher-fiber snacks are usually the best choice."
    },
    "myths_debunked": {
