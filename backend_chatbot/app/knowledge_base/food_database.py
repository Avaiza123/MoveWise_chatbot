...
FOOD_DATABASE = {
    "foods": {
        ...
        "peanut_butter": {
            ...
            "potassium": 49,
            "magnesium": 27,
            "benefits": ["Convenient calories", "Healthy fats", "Some protein", "Satiety", "Good pre-workout fuel in small amounts"],
            "note": "Calorie-dense; easy to overeat",
            "best_for": "Sandwiches, oats, smoothies",
            "shelf_life": "6-9 months pantry after opening",
            "cost_level": "$$",
            "preparation": "Stir before use if natural"
        },
        "cottage_cheese": {
            "category": "Protein + Dairy",
            "serving_size": "100g (low-fat)",
            "calories": 81,
            "protein": 11,
            "carbs": 3.4,
            "fat": 2.3,
            ...
            "sodium": 364,
            "calcium": 83,
            "benefits": ["Slow-digesting protein", "High protein", "Casein for recovery", "Budget-friendly", "Good before bed"],
            "preparation": "Eat cold or mix into bowls and smoothies",
            "best_for": "Pre-bed snack or high-protein meal",
            "shelf_life": "1-2 weeks refrigerated",
            "cost_level": "$$"
        },
        "tuna_canned": {
            "category": "Protein",
            "serving_size": "100g drained",
            "calories": 116,
            "protein": 26,
            "carbs": 0,
            "fat": 1,
            ...
            "sodium": 300,
            "potassium": 280,
            "benefits": ["Very high protein", "Convenient", "Budget-friendly", "Low calorie", "Good for meal prep"],
            "preparation": "Drain and use in salads, wraps, or rice bowls",
            "best_for": "Quick lunches and high-protein snacks",
            "shelf_life": "2-5 years unopened",
            "cost_level": "$"
        },
        "milk": {
            "category": "Dairy",
            "serving_size": "100ml (2% milk)",
            "calories": 50,
            "protein": 3.4,
            "carbs": 5,
            "fat": 2,
            ...
            "calcium": 120,
            "potassium": 150,
            "benefits": ["Calcium", "Protein", "Hydration", "Easy post-workout drink", "Useful in oats and shakes"],
            "preparation": "Drink cold or use in recipes",
            "best_for": "Breakfast, smoothies, recovery",
            "shelf_life": "5-7 days refrigerated after opening",
            "cost_level": "$"
        },
        "apple": {
            "category": "Fruit",
            ...
            "potassium": 195,
            "vitamin_c": 8.4,
            "benefits": ["Fiber", "Portable", "Satiety", "Hydrating fruit", "Good snack choice"],
            "best_for": "Snack or pre-workout fruit",
            "shelf_life": "1-2 weeks refrigerated",
            "cost_level": "$"
        },
        "quinoa": {
            "category": "Carbohydrate + Protein",
            "serving_size": "100g (cooked)",
            "calories": 120,
            "protein": 4.4,
            "carbs": 21,
            ...
            "potassium": 172,
            "magnesium": 64,
            "benefits": ["Complete amino acid profile", "Gluten-free", "More protein than rice", "Versatile", "Good for meal prep"],
            "preparation": "Rinse, then cook 1:2 quinoa to water",
            "best_for": "Lunch bowls and post-workout meals",
        ...
        "white_rice": {
            ...
            "sodium": 1,
            "potassium": 35,
            "benefits": ["Easy to digest", "Quick energy", "Good post-workout carb", "Cheap", "Simple to portion"],
            "preparation": "Cook until tender; rinse for fluffier texture",
            "best_for": "Post-workout or high-carb meals",
            "shelf_life": "2+ years dry",
            "cost_level": "$"
        },
        "berries": {
            "category": "Fruit",
